...
class S3Uploader:
    def __init__(self, access_key_id, secret_access_key, bucket_name, region='us-east-1'):
...
def create_s3_uploader():
    ...
    if not all([access_key, secret_key, bucket_name]):
        print("Warning: AWS credentials or bucket name not found in environment variables")
        return None
